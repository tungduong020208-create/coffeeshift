    ...
    <header className="w-full bg-[#271310] border-b border-[#3e2723] text-[#e4e4cc] sticky top-0 z-40 shadow-md">
      <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center bg-[#ff8f00] text-[#271310] rounded-full w-9 h-9 shadow-sm">
            <span className="material-symbols-filled text-2xl leading-none" data-icon="coffee">coffee</span>
          </div>
          <div>
